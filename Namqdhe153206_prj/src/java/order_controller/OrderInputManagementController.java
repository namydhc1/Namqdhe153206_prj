 ...
 * @author Namqd
 */
public class OrderInputManagementController extends HttpServlet {
...
//            request.setAttribute("storages", storages);
            ...
            request.getRequestDispatcher("view/order/order_input_management.jsp").forward(request, response);
        }
    }
